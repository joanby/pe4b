...
Se estima que el \blue{tiempo transcurrido entre dos averías graves  sigue una ley exponencial de parámetro $\lambda=\frac{1}{25}$ días}. 
...
La v.a. $T$ \red{tiempo entre dos averías graves} sigue una ley $Exp(\lambda=\frac{1}{25})$. 
