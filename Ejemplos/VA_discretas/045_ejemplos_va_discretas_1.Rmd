...
$$\sigma^2_I=Var(I)=Var(3\cdot X)=3\cdot Var(x)=3^2\cdot 1.1131=`r 9*1.1131`.$$
...
% Mon Jan 04 20:30:02 2021
\begin{table}[ht]
\centering
\begin{tabular}{rrrrrrr}
  \hline
x & prob & xprob & dif & difprob & x2 & x2prob \\ 
  \hline
...
$$\sigma_X^2=Var(X)=E((X_\mu)^2)=4.0211.$$



$$\sigma_X^2=Var(X)=E(X^2)-\mu^2=15.1100-3.3300^2=15.1100-`r 3.3300^2`=`r 15.1100- 3.3300^2`.$$
