...
* los percentiles $\chi_{\frac{\alpha}{2},n-1}$ y $\chi_{\frac{1-\alpha}{2},n-1}$. 
\pause
...
\begin{align*}
\left(\frac{(n-1)\cdot s^2}{\chi_{\frac{1-\alpha}{2},n-1}},\frac{(n-1)\cdot s^2}{\chi_{\frac{\alpha}{2},n-1}}\right)= & \left(\frac{24\cdot 100}{`r round(qchisq(0.975,24),3)`},\frac{24\cdot 100}{`r round(qchisq(0.025,24),3)`}\right)\\ = & (`r round(2400/qchisq(0.975,24),3)`,`r round(2400/qchisq(0.025,24),3)`).
\end{align*}
