...
En segundo lugar nos piden $P(>3.5)=1-P(\leq 3.5)=`r 1- round(pnorm(3.5,mean=3,sd=10),4)`$


Los cálculos los podemos hacer con R

```{r}
round(pnorm(4,mean=3.45,sd=1),4)# apartado a. P(X<4)
round(1-pnorm(3.5,mean=3.45,sd=1),4)# apartado b. P(X>3.5)
```
