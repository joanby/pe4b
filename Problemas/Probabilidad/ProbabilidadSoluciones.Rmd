...
4. Se selecciona un jurado de 12 miembros de un panel compuesto por 8 hombres y 8 mujeres.
...
\begin{align*}
P(\mathrm{R})= & P(\mathrm{RE})\cdot P(\mathrm{R}|\mathrm{RE})+P(\mathrm{RP})\cdot  P(\mathrm{R}|\mathrm{RP})+P(\mathrm{CD})\cdot P(\mathrm{R}|\mathrm{CD})+P(\mathrm{SS})\cdot P(\mathrm{R}|\mathrm{SS})\\
= & 0.1\cdot 0.8+0.57\cdot 0.76+0.24\cdot 0.51+0.09\cdot 0.14=`r 0.1*0.8+0.57*0.76+0.24*0.51+0.51*0.09`.
\end{align*}
