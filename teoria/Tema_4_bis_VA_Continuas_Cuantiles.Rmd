...
Sea $X$ una va.a $N(\mu.sigma)$  el cuartil $0<p<1$ será aquel valor de $x_p$ tal que $P(X\leq x_p)=p)$.
...
Los cuantiles $0.25$, $0.5$ y $0.75$ reciben el nombre de primer, cuartil, segundo cuartil o mediana y tercer cuartil. También se sule hablar  de deciles  y de centiles a los cuantiles que dividen en 10 partes  o en 100 partes la muestra.
...
#legend("toplef",legend=c(expression(N(mu[1],sigma[1]))),col=c("red"),lty=c(1))
